...
.filter-bar{display:flex;align-items:center;gap:10px;padding:12px 14px;background:var(--panel);border:1px solid var(--line)}.filter-title{margin-right:auto;display:flex;flex-direction:column}.filter-title b{font-family:var(--serif);font-size:17px;letter-spacing:.08em}.filter-title span,.panel-sub{color:var(--ink-3);font:12px var(--mono);letter-spacing:.1em}.filter-bar :deep(.el-select){width:120px}.filter-bar :deep(.el-date-editor){width:350px}
.panel{background:var(--panel);border:1px solid var(--line);padding:14px 16px}.panel-head{display:flex;align-items:center;border-bottom:1px solid var(--line);padding-bottom:8px;margin-bottom:10px}.panel-title{font-family:var(--serif);font-size:15px;letter-spacing:.06em}.signature-mini,.quality-badge{margin-left:auto;color:var(--ink-3);font:12px var(--mono)}.equipment-wall{margin-top:12px}.card-grid{display:grid;grid-template-columns:repeat(6,1fr);gap:9px}.equipment-card{--heat:.05;appearance:none;text-align:left;color:var(--ink);background:linear-gradient(color-mix(in srgb, var(--orange) calc(var(--heat) * 100%), transparent),color-mix(in srgb, var(--panel) 96%, transparent));border:1px solid var(--line);padding:10px;cursor:pointer;display:flex;flex-direction:column;min-width:0}.equipment-card:hover,.equipment-card.active{border-color:var(--cyan);box-shadow:0 0 0 1px color-mix(in srgb, var(--cyan) 18%, transparent) inset}.equipment-card b{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-top:5px}.equipment-card small,.card-area{color:var(--ink-3);font:12px var(--mono)}.card-area{color:var(--cyan)}.card-value{font:18px var(--mono);margin-top:10px}.card-value em{font-size:12px;color:var(--ink-3);font-style:normal;margin-left:4px}.equipment-card footer{display:flex;justify-content:space-between;color:var(--ink-3);font:12px var(--mono);margin-top:7px}.loading-state,.empty-state{padding:24px;text-align:center;color:var(--ink-3);border:1px dashed var(--line)}.loading-state{margin-top:12px;background:var(--panel)}
.profile-main{display:flex;flex-direction:column;gap:12px;margin-top:12px}.device-heading{display:flex;align-items:center;justify-content:space-between;gap:20px}.eyebrow{color:var(--cyan);font:12px var(--mono)}.device-heading h1{font-family:var(--serif);font-size:25px;letter-spacing:.08em;margin:3px 0}.device-heading p{color:var(--ink-3);font:12px var(--mono);margin:0}.heading-metrics{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;min-width:60%}.heading-metrics article{border-left:1px solid var(--line-strong);padding-left:12px;display:flex;flex-direction:column}.heading-metrics span,.heading-metrics small{color:var(--ink-3);font:12px var(--mono)}.heading-metrics b{font:20px var(--mono);margin:3px 0}.quality-ok b{color:var(--lime)}.quality-degraded b{color:var(--amber)}.quality-insufficient b{color:var(--red)}
.evidence-banner{display:grid;grid-template-columns:auto 1fr auto auto;gap:18px;align-items:center;padding:12px 16px;border:1px solid color-mix(in srgb, var(--red) 42%, transparent);background:var(--red-tint)}.evidence-banner>div{display:flex;flex-direction:column}.evidence-banner>div span{color:var(--red);font:11px var(--mono)}.evidence-banner>div b{font-family:var(--serif);font-size:16px}.evidence-banner p{color:var(--ink-2)}.evidence-banner dl{display:flex;gap:18px;margin:0}.evidence-banner dl div{display:flex;flex-direction:column}.evidence-banner dt{color:var(--ink-3);font:12px var(--mono)}.evidence-banner dd{margin:2px 0 0;font:13px var(--mono)}
.two-col{display:grid;grid-template-columns:1fr 1fr;gap:12px}.three-col{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}.small-chart{height:280px}.state-chart{height:330px}.chart-empty{height:230px;display:grid;place-items:center}.match-state{padding:8px;border:1px solid color-mix(in srgb, var(--lime) 35%, transparent);color:var(--lime);font-family:var(--mono);margin-bottom:8px}.match-state.missed{color:var(--red);border-color:color-mix(in srgb, var(--red) 42%, transparent);background:var(--red-tint)}/* .dark-table 变量由 cockpit-tokens 通用块提供 */.uncovered-window{padding:7px 8px;margin-top:6px;color:var(--red);border-left:2px solid var(--red);background:var(--red-tint);font:12px var(--mono)}.trial-tag{color:var(--amber);border:1px solid color-mix(in srgb, var(--amber) 40%, transparent);padding:1px 5px;font:12px var(--mono)}.trial-note{color:var(--ink-3);font-size:12px;margin:10px 0 0}.link-row{appearance:none;width:100%;display:flex;justify-content:space-between;align-items:center;text-align:left;background:none;border:0;border-bottom:1px solid var(--line);color:var(--ink);padding:9px 2px;cursor:pointer}.link-row span{display:flex;flex-direction:column}.link-row small{color:var(--ink-3);font:12px var(--mono)}.link-row em{color:var(--cyan);font:12px var(--mono);font-style:normal}.info-row{display:flex;justify-content:space-between;gap:8px;padding:9px 2px;border-bottom:1px solid var(--line)}.info-row span{color:var(--ink-3);font:12px var(--mono)}.signature-footer{display:flex;justify-content:space-between;color:var(--ink-3);font:12px var(--mono);padding:8px 2px}
