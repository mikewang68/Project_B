...
<style scoped>
.integration-panel{padding-top:6px}.integration-panel :deep(.el-tabs__header){padding:0 14px}.exchange-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px;margin:12px 0 20px}.exchange-grid article{padding:18px;border:1px solid var(--wms-border);border-radius:8px;background:var(--app-surface-secondary)}.exchange-grid h3{margin:0 0 6px}.exchange-grid p{color:var(--wms-text-secondary)}.button-grid{display:flex;flex-wrap:wrap;gap:8px}.import-row{display:flex;align-items:flex-start;gap:8px}.import-row .el-select{width:130px}.qimen-grid{display:grid;grid-template-columns:2fr 1fr;gap:28px;margin:22px 0}.qimen-grid aside{padding:18px;border-radius:8px;background:var(--app-hover-bg)}.qimen-grid aside h3{margin-top:0}.qimen-grid li{margin:10px 0;line-height:1.6}
</style>
