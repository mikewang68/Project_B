...
<style scoped>
.heading-actions{display:flex;gap:10px}.inventory-stats{display:grid;grid-template-columns:repeat(4,1fr);gap:14px}.inventory-stats>div{background:var(--el-bg-color);border:1px solid var(--el-border-color-lighter);border-radius:12px;padding:17px 20px;display:flex;align-items:center;justify-content:space-between}.inventory-stats span{color:var(--el-text-color-secondary);font-size:13px}.inventory-stats strong{font-size:24px;color:var(--app-text-title)}.inventory-stats .danger strong{color:var(--app-color-danger)}.inventory-panel{overflow:hidden}.frozen-qty,.negative{color:var(--app-color-warning)}.positive{color:var(--app-color-success)}.dialog-form{margin-top:18px}.operation-context{padding:12px 14px;margin:0 0 18px;background:var(--app-surface-secondary);border-radius:8px;color:var(--app-text-regular);font-size:13px}@media(max-width:900px){.inventory-stats{grid-template-columns:repeat(2,1fr)}}
</style>
